          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4 p-4 bg-accent rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">45 minutes • 2 hours ago</p>
              </div>
            </div>
            <div className="flex items-center space-x-4 p-4 bg-accent rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium">Burned 420 calories</p>
                <p className="text-sm text-muted-foreground">Cardio session • Yesterday</p>
              </div>
            </div>
          </div>
        </CardContent>
